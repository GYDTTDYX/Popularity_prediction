...
Our analysis exclude free games from our dataset. This decision is because for free-to-play games, in-app purchases often serve as alternatives to game sales. However, due to the unavailability of such data, the inclusion in our analysis would make our analysis inapproprate. 

In addition, we removed certain variables from our dataset that are non-essential for our analysis.
...
Furthermore, we will exclude the variables "Playtime in Current Two Weeks" since it may not be representative for older games, and "Average Playtime Forever" in favor of "Median Playtime Forever" due to potential distortions caused by AFK (Away From Keyboard) gamers. 
...
*Estimated Owners*: We will exclude games with an estimated owner count in the range of 0-0 and 0-20,000. This criteria ensures that we focus on games with a substantial player base.

*Median Playtime*: Games selected for analysis will have a median playtime exceeding 120 minutes. This the latest time that allows users to get refunds. This criterion ensure users' active engagement.
