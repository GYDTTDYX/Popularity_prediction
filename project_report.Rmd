...
Our analysis excludes free games since for free-to-play games, in-app purchases often serve as an indicator of popularity. However, due to the unavailability of such data, the inclusion in our analysis would make our analysis inappropriate. 

In addition, we removed certain non-essential variables from our dataset.

We eliminate columns containing URLs as we cannot make an analysis based on them.
